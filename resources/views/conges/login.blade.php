		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="{{ asset('images/udc.png') }}" alt="IMG">
				</div>

				<form class="login100-form validate-form"  method="POST" action="{{ route('conges.accueil') }}">
          @csrf
            ...
            required autocomplete="current-password" >
              ...
              {{ __('Se connecter') }}
					...
					<div class="text-center p-t-12">
						<span class="txt1">
              @if (Route::has('conges.password.request'))
