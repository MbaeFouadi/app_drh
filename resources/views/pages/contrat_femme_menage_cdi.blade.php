...
<body>
    <div>
        <div class="container"><br>
            ...
            <p>L'employeur s'engage à recruter ,pour les besoins de l'Université des Comores, Madame <strong>{{$employer->nom}} {{$employer->prenom}} </strong>, en qualité de femme de ménage. <br> <strong>{{$employer->nom}} {{$employer->prenom}} </strong> est placé sous l'autorité et le contrôle hiéarchique du Chef de Service de la Prévention et Sécurité Universitaire lequel organisera et procédera à son affectation en fonction des besoins des différents sites de l'Université des Comores. <br>La carrière du contractante évolue dans la catégorie C correspondant à des emplois spécialisés. Il requiert un niveau minimum de formation de BEPC , assorti d'une formation professionnelle. La contractante est soumis aux dispositions du manuel du Service de la Prevention et de la Sécrurité Universitaire ainsi qu'à celles des délibérations relatives aux statuts du cadre du personnel IATOS, notamment celle liées aux sanctions disciplinaires. <br> L'admission à la retraite qui marque la fin normale d'activité du contractuel est fixée à 55 ans.</p>
