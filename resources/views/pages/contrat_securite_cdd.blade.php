...
<body>
    <div>
        <div class="container"><br>
            ...
            <p>Le contractant est afféctée {{ $composante->composante }} en qualité d'agent de sécurité. <br> Elle est placée sous l'autorité hiérarchique du doyen de composante. <br> Au besoin la contractante peut être affectée à tout autre composante de l'Université des Comores. </p>
