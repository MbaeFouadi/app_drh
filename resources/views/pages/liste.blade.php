            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td >
                      <a href="{{route('fiche_signaletique',$data->id) }}">Voir la fiche</a> / <a class="btn btn-info btn-sm" href="{{route('employer.show',$data->id) }}">
                        <i class="fas fa-pencil-alt">
                        </i>
                      
                    </a> / <a class="btn btn-danger btn-sm text-left" href="{{route('fiche_signaletique',$data->id) }}">
