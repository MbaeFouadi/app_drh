                ...
                <form method="POST" action="{{ route('fonction.store')}}">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="{{old('fonction')}}" class="form-control" id="exampleInputEmail1" name="fonction" placeholder="Fonction">
                    </div>
                    @error('service')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" value="{{old('nombre')}}" name="nombre" id="exampleInputPassword1" placeholder="nombre">
                    </div>
                    @error('annee')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
