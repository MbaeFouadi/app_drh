          ...
          <h3 class="card-title">Congés</h3>
                ...
                <div class="card card-info">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">Edition contrat à durée déterminée</h3>

                    </div>
                    <!-- /.card-header -->
                    <div class="container">
                        <form action="{{route('form_cdd')}}" method="POST">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('duree') is-invalid @enderror " id="exampleInputEmail1" placeholder="Duée" name="duree" required>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('date_debut') is-invalid @enderror " id="exampleInputEmail1" placeholder="Date début" name="date_debut"  required>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date_fin" class="form-control @error('date_fin') is-invalid @enderror" id="exampleInputEmail1" placeholder="date_fin"  required>
