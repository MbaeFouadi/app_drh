              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @if ($conge->motif == "Demande en cours de traitement")
                        <p class="text-warning">Non traitée</p>
                    @endif
                    @if ($conge->motif == "Félicitation, Votre demande a été accepté.")
                        <p class="text-success">Acceptée</p>
                    @endif
                    
                    @if ($conge->motif != "Félicitation, Votre demande a été accepté." && $conge->motif != "Demande en cours de traitement")
                        <p class="text-danger">Refusée</p>
                    @endif
                  </td>
                  <td class="project-actions text-center"> 
                      @if ($conge->motif == "Demande en cours de traitement")
                      <a class="btn btn-info btn-sm" href="{{route('congesedit',[$conge->id,$conge->idEmpl])}}">
