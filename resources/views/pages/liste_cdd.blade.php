              ...
              <tbody>
                @foreach($contrats as $contrat)
                  ...
                  <tr>
                    ...
                    <td>
                      {{\Carbon\Carbon::parse($contrat->date_naissance)->translatedFormat('j F Y')}}

                    </td>
                    <td>
                      <a href="{{route('contrat_cdd',$contrat->employer_id)}}">Contrat</a>
                      <!-- / <a class="btn btn-info btn-sm" href="">
                        <i class="fas fa-pencil-alt">
                        </i>
                      
                    </a> / <a class="btn btn-danger btn-sm text-left" href="">
