...
<body>
    <div>
        <div class="container"><br>
            ...
            <p>L'employeur recrute Monsieur <strong>{{$employer->nom}} {{$employer->prenom}} </strong> Pour les besoins de l'Université.</p>
            <p><Strong><span>Article</span> 2: Affectation</Strong>
            <p>Le contractant est afféctée {{ $composante->composante }} en qualité d'agent de jardinier. <br> Elle est placée sous l'autorité hiérarchique du doyen de composante. <br> Au besoin la contractante peut être affectée à tout autre composante de l'Université des Comores. </p>
            ...
            <p>Le contractant s'engage à consacrer son temps de travail, dans la limite de la réglementation en vigeur, à l'exercice des fonctions liées à la mission qui lui est confiée exigeant une présence affective et continue. <br>Il ne peut exercer aucune autre activité professionnelle  pendant la durée du présent contrat.</p>
            ...
            <p>S'il n'est pas censée renoncer à ses conviction politiques, le contractant ne doit cependant jamais perdre de vue la réserve et le tact qu'exigent ses fonctions au sein de l'Université des Comores.</p>
            <p><strong><span>Article</span> 6:Secret professionnel</strong></p>
            <p>Le contractant s'abstient de communiquer à toute personne ou entité étrangère à l'Université des Comores les informations non publiées dont elle aura eu connaissance dans l'exercice de ses fonctions.</p>
